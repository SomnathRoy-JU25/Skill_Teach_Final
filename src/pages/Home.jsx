  ...
  return (
    <div>
      ...
      <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 text-white">
        ...
        <Link to={"/signup"}>
          <div className="group mx-auto mt-16 w-fit rounded-full bg-purple-600 p-1 font-bold text-purple-25 drop-shadow-[0_1.5px_rgba(255,255,255,0.25)] transition-all duration-200 hover:scale-95 hover:drop-shadow-none">
            <div className="flex flex-row items-center gap-2 rounded-full px-10 py-[5px] transition-all duration-200 group-hover:bg-purple-700">
